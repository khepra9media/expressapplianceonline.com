...
SERVICES = [
    ...
    dict(
        ...
        image="boilerpipesandtechnician.png", alt="Technician working on water heater pipes",
    ...
    dict(
        ...
        image="maninhvacwarehouse.png", alt="Appliance technician in the parts warehouse",
    ...
    dict(
        ...
        image="furnaceblower.png", alt="Furnace blower assembly",
